...
add_action( 'genesis_meta', 'brotherhood_register_page_genesis_meta' );

/**
 * Add widget support for homepage. If no widgets active, display the default loop.
 *
 */
function brotherhood_register_page_genesis_meta() {

	if ( is_active_sidebar( 'register-page-hero' ) || is_active_sidebar( 'register-page-1' ) || is_active_sidebar( 'register-page-2' ) || is_active_sidebar( 'register-page-3' ) || is_active_sidebar( 'register-page-4' ) ) {

	//* Enqueue scripts
		
	//* Add register-page body class
		...
		add_action( 'genesis_loop', 'brotherhood_register_page_widgets' );

	}

}

//* Add markup for register page widgets
function brotherhood_register_page_widgets() {
	...
	genesis_widget_area( 'register-page-hero', array(
		'before' => '<div id="register-page-hero" class="register-page-hero overlay"><div class="widget-area"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );

	genesis_widget_area( 'register-page-1', array(
		'before' => '<div id="register-page-1" class="register-page-1"><div class="flexible-widgets widget-area' . brotherhood_widget_area_class( 'register-page-1' ) . '"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );?>
...
<?php
	genesis_widget_area( 'register-page-2', array(
		'before' => '<div id="register-page-3" class="register-page-2"><div class="flexible-widgets widget-area' . brotherhood_widget_area_class( 'register-page-2' ) . '"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );

	genesis_widget_area( 'register-page-3', array(
		'before' => '<div id="register-page-4" class="register-page-3"><div class="flexible-widgets widget-area' . brotherhood_widget_area_class( 'register-page-3' ) . '"><div class="wrap">',
		'after'  => '</div></div></div>',
	) );
